...
public class DataType {
	...
	//code changed for PASSWORD
	private static final String PASSWORD_CLASS_NAME =
			"password";
    /**
    ...
    public static Value convertToValue(SessionInterface session, Object x,
		...
		if(x instanceof String){
			return ValuePassword.get((String)x);
		}
